...
public class DatabaseManager extends SQLiteOpenHelper {
    ...
    private final String TAG = "Database Management";
    ...
    public ArrayList<UserFormat> getAllUsers() {
        ...
        @SuppressLint("Recycle") Cursor cursor = db.rawQuery("SELECT * FROM " + TABLE_USER, null);
    ...
    public int NumberOfSensors() {
        SQLiteDatabase db = this.getReadableDatabase();
        @SuppressLint("Recycle") Cursor cursor = db.rawQuery("SELECT  * FROM " + TABLE_SENSOR, null);
        return cursor.getCount();
    }
